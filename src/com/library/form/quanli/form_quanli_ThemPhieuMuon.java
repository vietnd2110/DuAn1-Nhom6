...
public class form_quanli_ThemPhieuMuon extends javax.swing.JFrame {
...
//        txtMaNV.setText(XAuther.USER.getMaNV());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_quanli_ThemPhieuMuon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_quanli_ThemPhieuMuon().setVisible(true);
            }
        });
    }
